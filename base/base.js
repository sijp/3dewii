...
var Ewii3D = (function (self){
    ...
    /*
     * makes obj a grabbable object in this scene.
     * its action callbacks will be called and it
     * will have the ability to be grabbed and dropped accros
     * the 3d scene.
     */
    ...
    /*
     * translates the (3D) position to the screen projected X,Y coordinates
     */
    ...
    /*
     * returns the model's file name (js) to be loaded via ajax.
     */
    ...
    /*
     * builds a widget from the `opts` JSON.
     */
    ...
    /*
     * augment the widget generator `base`
     * every subwidget must call this method internally.
     */
    ...
    /* 
     * @returns the resolt of method on sub's prototype
     * 
     * calls method on sub's prototype (super call) and returns the result.
     * it supports additional args (variadic) that will be passed forward
     * to method.
     */
    self.superCall = function (sub,method){
        args = Array.prototype.slice.call(arguments,2);
        return Object.getPrototypeOf(sub)[method].apply(Object.getPrototypeOf(sub),args);
    }

    /*
     * loads the model's geometry from the opts objects
     * and creates a widget for it
     */
